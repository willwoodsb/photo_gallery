...
<div class="flex flex-row text-lg tracking-widest pt-4">
    ...
    <p class="my-auto ml-auto hidden md:flex md:flex-row ">
        ...
        <a href="{{$internal == true ? '' : '/'}}#showcase" class="hover:underline scroll">Showcase&Clients</a> /
        <a href="{{$internal == true ? '' : '/'}}#contact" class="hover:underline scroll">Contact</a>
    </p>
    <button class="md:hidden uppercase ml-auto flex flex-row my-auto menu open-menu">
        <p>Menu</p>
